...
# postgres
ghcr.io/narrowstack/dbt-core-docker:1.11.2-postgres-1.10.0

#snowflake
ghcr.io/narrowstack/dbt-core-docker1.9.4-snowflake-1.9.4
ghcr.io/narrowstack/dbt-core-docker1.11.2-snowflake-1.11.1

#clickhouse
ghcr.io/narrowstack/dbt-core-docker:1.10.9-clickhouse-1.9.2
ghcr.io/narrowstack/dbt-core-docker:1.11.2-clickhouse-1.9.8
```

### Base Image

There is also the base python images without the dbt-core or dbt-{{adapter}} images installed available as `ghcr.io/narrowstack/dbt-core-docker/base:3.14.2-base` and `ghcr.io/narrowstack/dbt-core-docker/base:latest`.
